...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:0.55em;">
  <tr>
    <td width="50%" valign="top"><strong>ผู้ถูกหักภาษี ณ ที่จ่าย : </strong><br />
      ...
      <td valign="top">
        <!-- <strong>เลขบัตรประจำตัวประชาชน <?php echo $receipt[0]['customer_tax']?> </strong><br> -->
        <strong>เลขประจำตัวผู้เสียภาษีอากร <?php echo $receipt[0]['customer_tax']?></strong>
      </td>
  </tr>
</table>
<br>
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:0.55em;">
  <tr>
    ...
    <td valign="top"><i class="fa fa-minus-square-o" aria-hidden="true"></i> (4) ภ.ง.ด.3</td>
  </tr>
  <tr>
    ...
    <td width="20%" valign="top"><i class="fa fa-check-square-o" aria-hidden="true"></i> (7) ภ.ง.ด.53</td>
    <td width="20%" valign="top">&nbsp;</td>
  </tr>
</table>
</div>
