                    ...
                    <td><div align="center">
                      <?php if($receipt_list['billing_status']==1){ ?>
                        ...
                        <?php }else if($receipt_list['billing_status']==0){ ?>
                          ...
                          <td><div align="center"><a href="<?php echo site_url('home/accept_paper')?>/<?php echo $receipt_list['billing_id']?>" target="_blank"><button type="button" <?php echo @$disabled ?>>พิมพ์ใบเสร็จรับเงิน</button></a></div></td>
                        </tr>
                        <?php $i++ ?>
                        <?php } ?>
                      </tbody>
